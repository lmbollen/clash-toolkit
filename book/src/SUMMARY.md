...
- [Synthesis Pipeline](./architecture/synthesis-pipeline.md)
- [Output Directory Structure](./architecture/directory-structure.md)
- [Clash Manifests](./architecture/clash-manifests.md)
- [Nextpnr Integration](./architecture/nextpnr-integration.md)
